...
class ExportFailureSheet extends StatelessWidget {
  final String errorMessage;
  final VoidCallback onRetry;
  final VoidCallback onSavePrivate;

  const ExportFailureSheet({
    super.key,
      ...
      child: SafeArea(
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Text(
                'Worth encountered an issue compiling or saving the PDF dossier.',
                textAlign: TextAlign.center,
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'To automatically save PDF dossiers directly to the device\'s shared Downloads/Worth folder, Worth needs Storage permissions (or All Files Access on Android 11 to 15). You can grant access in system settings, or choose to bypass permissions by saving to private storage.',
                          style: GoogleFonts.inter(
                            fontSize: 11,
